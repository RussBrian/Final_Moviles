...
const MiembrosScreen2 = () => {
  return (
    <View style={styles.miembrosScreen}>
      ...
      />
      <Text
        style={[styles.quieroSerVoluntario, styles.quieroSerVoluntarioTypo]}
      >
      ...
      <View style={[styles.miembrosScreenChild1, styles.miembrosChildLayout]} />
      <Image
        style={[styles.icons8NuevoPost641, styles.icons8Position]}
        contentFit="cover"
        source={require("../assets/icons8nuevopost64-12.png")}
      />
      <Text
        style={[styles.correoElectrnico, styles.cdulaTypo]}
      >{`Correo Electrónico `}</Text>
      <Text style={[styles.email1, styles.emailTypo]}>Email</Text>
      <View style={[styles.miembrosScreenChild2, styles.miembrosChildLayout]} />
      <Text
      ...
      <View style={[styles.miembrosScreenChild3, styles.miembrosChildLayout]} />
      ...
      <Image
        ...
        contentFit="cover"
        source={require("../assets/icons8emojidemarcadeverificacin48-12.png")}
      />
      <Image
        style={[styles.icons8Nombre641, styles.icons8Position]}
        contentFit="cover"
        source={require("../assets/icons8nombre64-11.png")}
      />
      <Image
        style={[styles.icons8TelfonoCelular64, styles.icons8Layout1]}
        contentFit="cover"
        source={require("../assets/icons8telfonocelular641.png")}
      />
      <Image
        style={[styles.icons8RoboDeIdentidad64, styles.email2Position]}
        contentFit="cover"
        source={require("../assets/icons8robodeidentidad641.png")}
      />
      <Image
        style={styles.miembrosScreenChild4}
        contentFit="cover"
        source={require("../assets/rectangle-27.png")}
      />
      <Image
        style={styles.icons8Voluntario641}
        contentFit="cover"
        source={require("../assets/icons8voluntario641.png")}
      />
      <Text
        style={[
          styles.formularioEnviadoCorrectamme,
          styles.quieroSerVoluntarioTypo,
        ]}
      >
        Formulario enviado correctammente!
      </Text>
      <Image
        style={styles.icons8PginaPrincipal644}
        contentFit="cover"
...
export default MiembrosScreen2;
